...
fileToRead = "dataset.csv"  #csv file name or absolute path to be open.
fileToWrite = "dataset.arff" #name as how you'll save your arff file.
relation = "Dataset" #how you'll like to call your relation as.
